...
<script src="<%=request.getContextPath()%>/resources/assets/js/select2.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
<script src="<%=request.getContextPath()%>/resources/assets/js/jqGrid/i18n/grid.locale-cn.js"></script>
